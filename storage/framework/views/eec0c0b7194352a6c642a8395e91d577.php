            ...
            <div class="max-w-8xl mx-auto sm:px-6 lg:px-8 grid-cols-4 gap-4">
                ...
                <h2 class="text-4xl font-extrabold dark:text-white text-center mt-12">Главная</h2>
                    <div class="p-6 text-gray-900 dark:text-gray-100 grid grid-cols-4 gap-4">
                        ...
                        <div>
                            <a href="<?php echo e(route('videos', $ar->id)); ?>" class='text-sm sm:text-lg'>
                                <p>Название: <?php echo e($ar->title); ?></p>
                            </a>
                            <a href="<?php echo e(route('videos', $ar->id)); ?>" class='text-sm sm:text-lg'>
                                <p>Описание: <?php echo e($ar->description); ?></p>
                            </a>
                            <img src="<?php echo e('image' . '/' . $ar->imageSRC); ?>" alt="fgh" width="500px" class='rounded-xl'>
...
<?php endif; ?><?php /**PATH C:\Users\21038\Desktop\Новая папка\main\resources\views/main.blade.php ENDPATH**/ ?>
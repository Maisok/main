...
<div class="mt-12">
    <form class="max-w-sm mx-auto" action="<?php echo e(route('pushvideos')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <p>Название</p>
...
<?php endif; ?><?php /**PATH C:\Users\21038\Desktop\Новая папка\main\resources\views/addvideo.blade.php ENDPATH**/ ?>